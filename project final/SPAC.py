...
def play_welcome_sound():
        pygame.mixer.init()
        pygame.mixer.music.load("C:\\Users\\HP\\Downloads\\project final\\project final\\welcome.mp3")  # Adjust path if necessary
...
def main():
    ...
    reference_image_path = "C:\\Users\\HP\\Downloads\\project final\\project final\\vinay.jpg"
    #reference_image_path = "C:\\Users\\HP\\Downloads\\project final\\project final\\janhavi.jpeg"
    ...
    if ret:
        ...
        if facial_recognition_authorized and authorized:
            ...
            subprocess.Popen(["streamlit", "run", "C:\\Users\\HP\\Downloads\\project final\\project final\\Siren.py"])
